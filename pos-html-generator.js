...
/* ═══════════════════════════════════════════════════════════════════
   ...
   Architettura header/footer Puppeteer nativo (displayHeaderFooter:true):
     ...
     Numerazione: pageNumber / totalPages iniettati da Chrome internamente
                  (deterministici, zero stima, zero 2-pass manuale).
   ═══════════════════════════════════════════════════════════════════ */
...
/* ── DOC: solo padding laterale — verticale gestito da Puppeteer ────── */
.doc {
  width: 100% !important;
...
<div class="cover">
  ...
  <div class="cover-sidebar">
    <div class="cover-sidebar-brand" style="display:flex;align-items:center;gap:5pt"><svg width="9" height="10" viewBox="0 0 544 592" style="flex-shrink:0"><path fill="currentColor" fill-rule="evenodd" d="M 4 4 L 311 4 L 333 6 L 365 12 L 394 21 L 430 38 L 450 51 L 478 75 L 493 92 L 507 112 L 526 151 L 537 195 L 539 214 L 539 245 L 533 285 L 521 321 L 511 341 L 498 361 L 487 375 L 465 397 L 447 411 L 406 434 L 372 446 L 340 453 L 310 456 L 148 456 L 147 587 L 4 587 L 4 4 Z M 107 100 L 305 100 L 329 103 L 354 110 L 370 117 L 389 129 L 413 153 L 421 165 L 429 182 L 434 199 L 437 219 L 437 240 L 433 265 L 428 280 L 419 298 L 408 313 L 394 327 L 377 339 L 359 348 L 338 355 L 305 360 L 148 360 L 147 443 L 107 483 L 107 100 Z"/></svg>Palladia</div>
