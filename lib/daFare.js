...
async function buildDaFare(companyId, userId, { todayStr = romeDate() } = {}) {
  ...
  const [workersRes, equipRes, companyRes, sitesRes, docsRes, notifRes, weatherRes, exitsRes, subsRes, prenRes] = await Promise.all([
  ...
  for (const r of [workersRes, equipRes, companyRes, sitesRes, docsRes, notifRes, weatherRes, exitsRes, subsRes, prenRes]) {
