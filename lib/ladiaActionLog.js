...
async function logAction({ companyId, userId, req, conversationId, resourceName, action, recordId, record, previousValues, changedFields, fullRowSnapshot, auditActionOverride }) {
  ...
  if (!resource) {
    ...
    return { actionHistoryId: null, summary: null, resource: resourceName, action, record: record || null, previous: previousValues || null, changedFields: changedFields || null };
  }
  ...
  return { actionHistoryId, summary, resource: resourceName, action, record: record || null, previous: previousValues || null, changedFields: changedFields || null, undoable: isUndoable(resource, action) };
}
