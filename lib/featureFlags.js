...
const FEATURES = {
  ...
  // una navigazione a cartelle (cantieri/lavoratori/subappaltatori/azienda/
  // buste paga/formazione + smart folder "in scadenza"), dove un documento
  // può vivere in più cartelle insieme. OFF di default, stesso pattern degli
  // altri flag document_*, finché non verificato dal vivo su company reali.
  document_folders_v1: process.env.FEATURE_DOCUMENT_FOLDERS_V1_DEFAULT === 'true',
  // Fast-follow F-045: ultimi 2 ingressi verso le cartelle, stesso pattern di
  // document_hub_entry_worker/formazione/site — Risorse.tsx (dettaglio
  // subappaltatore) e PayslipsModal.tsx sostituiscono la lista incorporata
  // con un link verso /documenti, tenendo il form di caricamento in loco.
