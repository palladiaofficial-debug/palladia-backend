...
async function createRecord(resourceName, rawPayload, companyId, userId, req, opts = {}) {
  ...
  return { success: true, record: data, actionHistoryId, undoSummary: summary, resource: resourceName, action: 'create', undoable: isUndoable(resource, 'create') };
}
...
async function updateRecord(resourceName, recordId, rawPatch, companyId, userId, req, opts = {}) {
  ...
  return { success: true, record: data, previous: before || {}, actionHistoryId, undoSummary: summary, resource: resourceName, action: 'update', undoable: isUndoable(resource, 'update') };
}
