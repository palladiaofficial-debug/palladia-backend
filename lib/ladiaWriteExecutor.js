...
async function checkOrProposeGate({ resourceName, action, row, companyId, userId, conversationId, opts, toolName, toolInput, summary }) {
...
async function executeWrite({
  ...
  const gate = await checkOrProposeGate({ resourceName, action, row, companyId, userId, conversationId, opts, toolName, toolInput, summary });
  if (gate) return gate;
