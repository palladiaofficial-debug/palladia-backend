...
// PATCH /subcontractors/:id/sites/:siteId/economia (F-188, AUDIT.md)
const subcontractorSiteEconomiaSchema = z.object({
  budget_totale:   z.number().min(0).nullable().optional(),
  sal_percentuale: z.number().min(0).max(100).optional(),
}).strip().refine(v => v.budget_totale !== undefined || v.sal_percentuale !== undefined, {
  message: 'almeno un campo tra budget_totale e sal_percentuale è obbligatorio',
});
