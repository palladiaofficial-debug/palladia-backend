-- 158_documents_sync_verify_function_v3.sql
-- Fase 2, Scaglione 3 — la funzione di verifica ricorrente deve controllare
-- tutte e nove le tabelle unificate, comprese le 3 dello Scaglione 3.
-- ladia_document_templates è inclusa anche senza adapter frontend: l'integrità
-- dati non dipende dall'esistenza di una UI. Nome funzione già generico da
-- 155 (verify_documents_sync), nessun rename necessario.
