-- 155_documents_sync_verify_function_v2.sql
-- Fase 2, Scaglione 2 — la funzione di verifica ricorrente deve controllare
-- tutte e sei le tabelle unificate, non solo le quattro dello Scaglione 1.
-- Sostituisce verify_documents_sync_tier1() con verify_documents_sync()
-- (nome non più legato a un singolo scaglione, coprirà anche i futuri).

DROP FUNCTION IF EXISTS verify_documents_sync_tier1();
