...
// Storico timbrature, buste paga e relativo PDF/presa visione sono dati personali
// (non di conformità cantiere) — vivono SOLO in routes/v1/workerArea.js dietro
// login con codice fiscale (POST /api/v1/area/:code/auth + verifyWorkerArea).
// Erano stati reintrodotti qui dietro il solo badge_code (pubblico, stampato sul
// QR del badge fisico) per sbloccare un 404 del frontend l'11/7 — rimosso il
// 16/7: il frontend ora usa il flusso con CF, questi endpoint non servono più e
// il badge_code da solo non deve mai bastare per vedere stipendio/presenze.
...
<div class="card" id="front">
  <div class="fh">
    <div class="fh-brand" style="display:inline-flex;align-items:center;gap:5px"><svg width="8" height="9" viewBox="0 0 544 592" style="flex-shrink:0"><path fill="currentColor" fill-rule="evenodd" d="M 4 4 L 311 4 L 333 6 L 365 12 L 394 21 L 430 38 L 450 51 L 478 75 L 493 92 L 507 112 L 526 151 L 537 195 L 539 214 L 539 245 L 533 285 L 521 321 L 511 341 L 498 361 L 487 375 L 465 397 L 447 411 L 406 434 L 372 446 L 340 453 L 310 456 L 148 456 L 147 587 L 4 587 L 4 4 Z M 107 100 L 305 100 L 329 103 L 354 110 L 370 117 L 389 129 L 413 153 L 421 165 L 429 182 L 434 199 L 437 219 L 437 240 L 433 265 L 428 280 L 419 298 L 408 313 L 394 327 L 377 339 L 359 348 L 338 355 L 305 360 L 148 360 L 147 443 L 107 483 L 107 100 Z"/></svg>PALLADIA</div>
    <div class="fh-right">
