...
const { startDailyDocCheckCron }    = require('./services/dailyDocCheckCron');
...
const { startSiteOccupazioneExpiryCron }    = require('./services/siteOccupazioneExpiryCron');
const { startSubcontractorExpiryCron }      = require('./services/subcontractorExpiryCron');
