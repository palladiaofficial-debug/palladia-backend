...
async function runOne(fileName) {
  ...
  await supabase.from('_migrations').insert({ file_name: fileName }).then(null, () => {});
  console.log(`${fileName} applicata.`);
}

runOne('183_consultant_sells_courses_backfill_bookings.sql');
