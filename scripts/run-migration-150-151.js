...
async function run() {
  await runOne('150_documents_unified_tier1.sql');
  await runOne('151_documents_tier1_sync_triggers.sql');
  console.log('Scaglione 1: tabella documents + trigger di sync + backfill completati.');
}
