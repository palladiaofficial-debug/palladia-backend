...
async function run() {
  await runOne('165_email_invoice_ingest.sql');
  console.log('Migrazione 165: canale fatture via email — tabelle email_ingest_*, colonne dedup/nota di credito su company_expenses, tassonomia source pulita a manual|acube|email.');
}
