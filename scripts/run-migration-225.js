...
async function run() {
  await runOne('225_company_expenses_recurring_link.sql');
  console.log('Migrazione 225: company_expenses.recurring_expense_id per riconciliare le spese fisse mensili (F-216).');
}
